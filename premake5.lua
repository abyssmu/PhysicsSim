...
project "Core"
	...
	files { 
		"%{prj.location}/src/core/**.hpp", 
		"%{prj.location}/src/core/**.cpp",
		"%{prj.location}/src/utils/**.hpp"
	}
...
project "Graphics"
	...
	files { 
		"%{prj.location}/src/graphics/**.hpp", 
		"%{prj.location}/src/graphics/**.cpp",
		"%{prj.location}/src/graphics/shaders/**.fs",
		"%{prj.location}/src/graphics/shaders/**.vs",
		"%{prj.location}/src/graphics/objects/**.hpp",
		"%{prj.location}/src/graphics/objects/**.cpp"
	}

	excludes {
		"%{prj.location}/src/graphics/main.cpp"
	}
...
project "Simulation"
	...
	files { 
		"%{prj.location}/src/simulation/**.hpp", 
		"%{prj.location}/src/simulation/**.cpp"
	}
